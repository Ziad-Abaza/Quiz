  ...
  const translations = {
    "ar": {
      ...
      "admin": {
        ...
        "resetAllDevicesBtn": "إعادة ضبط جميع أجهزة الطلاب / السماح بإعادة الاختبار 🔄",
        "resetAllDevicesConfirm": "هل أنت متأكد من رغبتك في إعادة ضبط وإلغاء قفل جميع أجهزة الطلاب عن بُعد؟ سيسمح هذا لجميع الطلاب بإجراء محاولة اختبار جديدة دون حذف النتائج السابقة.",
        "resetAllDevicesAlert": "تم إصدار أمر إعادة الضبط العام بنجاح! سيتم إلغاء قفل جميع أجهزة الطلاب تلقائيًا للسماح بمحاولة جديدة. 🚀",
        ...
        "reviewAnswersBtn": "عرض الإجابات 🔍",
        "reviewModalTitle": "مراجعة إجابات الطالب 📋",
        "reviewQuizTitle": "اختبار: {title}",
        "reviewQuestionLabel": "السؤال #{num}:",
        "reviewStudentAns": "إجابة الطالب:",
        "reviewCorrectAns": "الإجابة النموذجية الصحيحة:",
        "reviewStatusCorrect": "إجابة صحيحة ✅",
        "reviewStatusWrong": "إجابة خاطئة ❌",
        "reviewTotalScore": "الدرجة الإجمالية للطالب:",
        "reviewCloseBtn": "إغلاق نافذة المراجعة ✖",
    ...
    "en": {
      ...
      "admin": {
        ...
        "resetAllDevicesBtn": "Reset All Devices / Allow Retake 🔄",
        "resetAllDevicesConfirm": "Are you sure you want to remotely reset and unlock all student devices? This will allow all students to start a new exam attempt without deleting previous results.",
        "resetAllDevicesAlert": "Global reset command issued successfully! All student devices will automatically unlock and allow new attempts. 🚀",
        ...
        "reviewModalTitle": "Student Answers Audit & Review 📋",
        "reviewQuizTitle": "Quiz: {title}",
        "reviewQuestionLabel": "Question #{num}:",
        "reviewStudentAns": "Student Selected Answer:",
        "reviewCorrectAns": "Model Correct Answer:",
        "reviewStatusCorrect": "Correct ✅",
        "reviewStatusWrong": "Incorrect ❌",
        "reviewTotalScore": "Overall Student Score:",
